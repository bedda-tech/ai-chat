  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        title: "Chat Platform Integrations (Slack, Discord, GitHub)",
        description:
          "Native bots for Slack, Discord, and GitHub — bring multi-model AI access to where teams already work",
        status: "completed",
        priority: "high",
        effort: "Completed",
...
export const expectedImpact = {
  competitiveAdvantages: {
    ...
    platformBots: "Slack/Discord/GitHub bots — multi-model AI inside team workspaces",
  },
  revenueProjections: {
