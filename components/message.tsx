      ...
      >
        ...
        >
          ...
          {mode === "view" &&
            isLastInGroup &&
            formatRelativeTime(
              message.metadata?.createdAt as string | undefined
            ) && (
              <div
                className={cn(
                  "flex opacity-40 transition-opacity group-hover/message:opacity-100",
                  {
...
export const PreviewMessage = memo(
  ...
  (prevProps, nextProps) => {
    ...
    if (prevProps.isFirstInGroup !== nextProps.isFirstInGroup) {
      return false;
    }
    if (prevProps.isLastInGroup !== nextProps.isLastInGroup) {
      return false;
    }
