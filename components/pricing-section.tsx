...
const tiers = [
  ...
  },
  {
    ...
    features: [
      ...
      "Document & code artifact creation",
      "Audio transcription",
      "File uploads (25MB)",
    ],
    cta: "Start Plus",
  ...
  },
  {
    ...
    features: [
      ...
      "Unlimited monthly messages",
      "Everything in Plus",
      "Priority model access (faster responses at peak times)",
      "Early access to newly released models",
  ...
  },
  {
    ...
    features: [
      ...
      "Everything in Pro",
      "Beta model access (new models before general release)",
      "Priority support",
